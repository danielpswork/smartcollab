...
public class CardsApi {
	...
	public List<Card> getCardsByLogin() {
		return service.getLoggedUserCards();
	}
	...
	@RequestMapping(method = RequestMethod.POST, value = "/comment/delete")
	@ResponseStatus(HttpStatus.CREATED)
	public Card deleteComment(@RequestBody List<String> commentData) {
		return service.deleteComment(commentData);
	}
